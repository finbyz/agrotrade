(() => {
  // ../agrotrade/agrotrade/public/js/utils.js
  ...
  $.extend(erpnext.utils, {
    ...
    add_dimensions: function(report_name, index) {
      let filters2 = frappe.query_reports[report_name].filters;
      frappe.call({
        method: "erpnext.accounts.doctype.accounting_dimension.accounting_dimension.get_dimensions",
        callback: function(r) {
          let accounting_dimensions = r.message[0];
          accounting_dimensions.forEach((dimension) => {
            let found = filters2.some((el) => el.fieldname === dimension["fieldname"]);
            if (!found) {
              filters2.splice(index, 0, {
    ...
    const fields = [{
      ...
      get_query: function() {
        ...
        if (frm.doc.doctype == "Sales Order") {
          filters2 = { "is_sales_item": 1 };
        } else if (frm.doc.doctype == "Purchase Order") {
          if (frm.doc.is_subcontracted == "Yes") {
            filters2 = { "is_sub_contracted_item": 1 };
          } else {
            filters2 = { "is_purchase_item": 1 };
          }
        }
        return {
  ...
  // ../agrotrade/agrotrade/public/js/gst_itemised_sales_register.js
  ...
  var filters = frappe.query_reports["Item-wise Sales Register"]["filters"];
  ...
  // ../agrotrade/agrotrade/public/js/gst_itemised_purchase_register.js
  ...
  // ../agrotrade/agrotrade/public/js/general_ledger.js
...
//# sourceMappingURL=agrotrade.bundle.DNVLEIC7.js.map
